...
export default function Home() {
  return (
    <font className={roboto.className}>
      <main className=' flex justify-center bg-gradient-to-b from-[#0f0c29] via-[#302b63] to-[#24243e] h-screen'>
        <div className='flex flex-col w-[80%] sm:flex-row justify-center items-center sm:w-full h-screen'>
